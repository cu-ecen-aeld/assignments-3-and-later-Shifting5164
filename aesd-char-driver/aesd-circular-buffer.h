...
typedef struct aesd_circular_buffer
{
     ...
     */
    aesd_buffer_entry  entry[AESDCHAR_MAX_WRITE_OPERATIONS_SUPPORTED];
    /**
...
extern char *aesd_circular_buffer_add_entry(aesd_circular_buffer *buffer, const aesd_buffer_entry *add_entry);
